...
export const test = base.extend<TestFixture>({
    ...
    inventoryPage: async ({ page }: { page: Page }, use: (fixture: InventoryPage) => Promise<void>) => {
        await use(new InventoryPage(page));
    },
    itemDetailPage: async ({ page }: { page: Page }, use: (fixture: ItemDetailPage) => Promise<void>) => {
        await use(new ItemDetailPage(page));
    },
    cartPage: async ({ page }: { page: Page }, use: (fixture: CartPage) => Promise<void>) => {
        await use(new CartPage(page));
    },
    checkoutStepOnePage: async ({ page }: { page: Page }, use: (fixture: CheckOutStepOnePage) => Promise<void>) => {
        await use(new CheckOutStepOnePage(page));
    },
    checkoutStepTwoPage: async ({ page }: { page: Page }, use: (fixture: CheckOutStepTwoPage) => Promise<void>) => {
        await use(new CheckOutStepTwoPage(page));
    },
    checkoutCompletePage: async ({ page }: { page: Page }, use: (fixture: CheckOutCompletePage) => Promise<void>) => {
